 ...
 * @author Maksym.
 */
public class AddApartments implements Command {
    ...
    Logger logger = Logger.getLogger(AddApartments.class.getName());
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (session.getAttribute("admin") != null) {
            ...
            try {
                ...
                logger.error("Error in AddApartments when converting String to Date: " + e);
            }
            ...
            response.addHeader("Location", "editDBApartments.jsp");
